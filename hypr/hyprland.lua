...
if palette_chunk then
    ...
    if ok and type(loaded) == "table" then palette = loaded end
end
...
-- Workspace Rules
-- =========================================================================
for i = 1, 8  do hl.workspace_rule({ workspace = tostring(i), monitor = "eDP-1" }) end
...
if hymission then
    hl.config({ plugin = { hymission = { layout_engine = "mission-control", only_active_workspace = 1 } } })
