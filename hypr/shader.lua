...
M.ui_state = {
    theme           = "dark",
    wallpaper_light = home .. "/.local/state/theme/current_wallpaper",
    wallpaper_dark  = home .. "/.local/state/theme/current_wallpaper",
}
...
M.complex_modes = {
    ...
    ["CRT Mode"] = {
        ...
        activate = function(shader_path)
            ...
            hl.exec_cmd("awww img " .. home .. "/Pictures/retro/van.png --transition-type wipe --transition-pos center --transition-duration 1.5")
