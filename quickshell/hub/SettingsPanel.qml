...
Item {
    ...
    Flickable {
        ...
        GridLayout {
            ...
            SCard {
                ...
                RowLayout {
                    ...
                    CPicker {
                        ...
                        currentHex: root.theme ? root.flatHex(root.theme.accent, root.theme.bgMain) : "#7aa1a6"
                ...
                RowLayout {
                    ...
                    SBtn { label: "Wallpaper colors"
                        onTriggered: Quickshell.execDetached([Quickshell.env("HOME") + "/.config/hypr/scripts/pywal.sh"])
                    }
                    Item { Layout.fillWidth: true }
            ...
            SCard {
                ...
                FileView { id: weatherConf; path: Lib.Configuration.weatherConfigPath }
                    ...
                    RowLayout {
                        ...
                        Repeater {
                            ...
                            delegate: Rectangle {
                                ...
                                color: active ? (root.theme ? root.theme.accent : "#7aa1a6") : "transparent"
                                Behavior on color { ColorAnimation { duration: 180 } }
                                Text {
            ...
            SCard {
                ...
                RowLayout {
                    Layout.fillWidth: true
                    SLabel { text: "Pointer speed" }
                    Item { Layout.fillWidth: true }
                    Text { text: (Lib.InputService.mouseSpeed > 0 ? "+" : "") + Lib.InputService.mouseSpeed.toFixed(2)
                        font.family: root.theme ? root.theme.textFont : ""; font.pixelSize: 14
                        color: root.theme ? root.theme.textSecondary : "#888" }
                }
                SSlider { from: -1; to: 1; stepSize: 0.05; value: Lib.InputService.mouseSpeed
                    onMoved: (v)=>{ Lib.InputService.mouseSpeed=v; Lib.InputService.save() } }
                SDivider {}
                SToggle { label: "Pointer acceleration"; checked: Lib.InputService.mouseAcceleration
                    onToggled: (v)=>{ Lib.InputService.mouseAcceleration=v; Lib.InputService.save() } }
                SToggle { label: "Natural scrolling"; checked: Lib.InputService.mouseNaturalScroll
                    onToggled: (v)=>{ Lib.InputService.mouseNaturalScroll=v; Lib.InputService.save() } }
                SToggle { label: "Left-handed buttons"; checked: Lib.InputService.mouseLeftHanded
                    onToggled: (v)=>{ Lib.InputService.mouseLeftHanded=v; Lib.InputService.save() } }
            }
            ...
            SCard {
                ...
                RowLayout {
                    ...
                    SLabel { text: "Pointer speed" }
                    Item { Layout.fillWidth: true }
                    Text { text: (Lib.InputService.touchpadSpeed > 0 ? "+" : "") + Lib.InputService.touchpadSpeed.toFixed(2)
                        font.family: root.theme ? root.theme.textFont : ""; font.pixelSize: 14
                        color: root.theme ? root.theme.textSecondary : "#888" }
                }
                SSlider { from: -1; to: 1; stepSize: 0.05; value: Lib.InputService.touchpadSpeed
                    onMoved: (v)=>{ Lib.InputService.touchpadSpeed=v; Lib.InputService.save() } }
                SDivider {}
                SToggle { label: "Natural scrolling"; checked: Lib.InputService.touchpadNaturalScroll
                    onToggled: (v)=>{ Lib.InputService.touchpadNaturalScroll=v; Lib.InputService.save() } }
                SToggle { label: "Tap to click"; checked: Lib.InputService.touchpadTapToClick
                    onToggled: (v)=>{ Lib.InputService.touchpadTapToClick=v; Lib.InputService.save() } }
                SToggle { label: "Disable while typing"; checked: Lib.InputService.touchpadDisableWhileTyping
                ...
                RowLayout {
                    ...
                    ColumnLayout {
                        ...
                        Rectangle {
                            ...
                            color: root.theme ? root.theme.bgItem : "#2d353b"
                            border.width: 1; border.color: pfpIn.activeFocus ? (root.theme ? root.theme.accent : "#7aa1a6") : (root.theme ? root.theme.outline : "#333")
                            ...
                            TextInput {
                                ...
                                selectionColor: root.theme ? Qt.rgba(root.theme.accent.r,root.theme.accent.g,root.theme.accent.b,0.35) : "#407aa1a6"
    ...
    component SToggle: Item {
        ...
        RowLayout {
            ...
            Rectangle {
                ...
                color: tog.checked ? (root.theme ? root.theme.accent : "#7aa1a6") : (root.theme ? root.theme.subtleFill : "#2d353b")
                Behavior on color { ColorAnimation { duration: 200 } }
                border.width: 1; border.color: root.theme ? root.theme.outline : "#333"
                Rectangle {
    ...
    component SField: ColumnLayout {
        ...
        Rectangle {
            ...
            Behavior on color { ColorAnimation { duration: 150 } }
            border.width: 1; border.color: sfIn.activeFocus ? (root.theme ? root.theme.accent : "#7aa1a6")
    ...
    component SSlider: Item {
        id: ssl; property real from: 1; property real to: 20; property real value: 7; property real stepSize: 1
        signal moved(real v)
        ...
        Rectangle {
            ...
            Rectangle {
                ...
                color: root.theme ? root.theme.accent : "#7aa1a6"
                Behavior on color { ColorAnimation { duration: 200 } }
            }
        }
        Rectangle {
            ...
            border.width: 2
            border.color: sDrag.pressed ? (root.theme ? root.theme.accent : "#7aa1a6")
        ...
        MouseArea {
            ...
            function go(mx) { var f=Math.max(0,Math.min(1,mx/ssl.width)); var v=Number((Math.round((ssl.from+f*(ssl.to-ssl.from))/ssl.stepSize)*ssl.stepSize).toFixed(4)); ssl.value=v; ssl.moved(v) }
    ...
    component SBtn: Item {
        ...
        Rectangle {
            ...
            color: sb.accent
                ? (bMa.containsPress ? Qt.darker(root.theme ? root.theme.accent : "#7aa1a6", 1.08)
                    : bMa.containsMouse ? Qt.lighter(root.theme ? root.theme.accent : "#7aa1a6", 1.14)
    ...
    component CPicker: ColumnLayout {
        id: cp; property string label: ""; property string currentHex: "#7aa1a6"
        ...
        RowLayout {
            ...
            Rectangle {
                ...
                color: root.validHex(hexIn.text) ? hexIn.text : (root.theme ? root.theme.accent : "#7aa1a6")
                border.width: 2; border.color: cp._open ? (root.theme ? root.theme.accent : "#7aa1a6") : (root.theme ? root.theme.outline : "#333")
                Behavior on color { ColorAnimation { duration: 100 } }
                Behavior on border.color { ColorAnimation { duration: 150 } }
            ...
            Rectangle {
                ...
                color: root.theme ? root.theme.bgItem : "#2d353b"
                border.width: 1; border.color: hexIn.activeFocus ? (root.theme ? root.theme.accent : "#7aa1a6") : (root.theme ? root.theme.outline : "#333")
                Behavior on border.color { ColorAnimation { duration: 150 } }
                TextInput {
                    id: hexIn
    ...
    component CSlider: RowLayout {
        ...
        Item {
            ...
            Rectangle {
                ...
                border.width: 2; border.color: csDrag.pressed ? (root.theme ? root.theme.accent : "#7aa1a6") : Qt.rgba(0,0,0,0.3)
