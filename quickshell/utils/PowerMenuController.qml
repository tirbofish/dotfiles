...
FocusScope {
    ...
    property color walBackground: "#141719"
    property color walForeground: "#dde5df"
    property color walAccent: "#7aa1a6"
    property color walSecondary: "#7aa1a6"
    property color walDanger: "#e67e80"
    property url walWallpaper: ""
