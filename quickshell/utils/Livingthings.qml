...
Item {
    ...
    QtObject {
        id: theme
        property color card: skin.ctrl.walBackground
        property color tile: Qt.lighter(skin.ctrl.walBackground, 1.7)
        property color tileHover: Qt.lighter(skin.ctrl.walBackground, 2.2)
        property color text: skin.ctrl.walForeground
        property color accent: skin.ctrl.walAccent
        property color danger: skin.ctrl.walDanger
        property color activeText: skin.ctrl.walBackground
        property url activeImg: skin.ctrl.walWallpaper
    }
