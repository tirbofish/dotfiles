...
Item {
    ...
    QtObject {
        id: theme
        property color bg:      skin.ctrl.walBackground
        property color fg:      Qt.lighter(skin.ctrl.walBackground, 1.7)
        property color dim:     skin.ctrl.walSecondary
        property color line:    Qt.rgba(skin.ctrl.walForeground.r, skin.ctrl.walForeground.g, skin.ctrl.walForeground.b, 0.15)
        property color selBg:   skin.ctrl.walAccent
        property color selFg:   skin.ctrl.walBackground
        property color danger:  skin.ctrl.walDanger
        property color confirm: skin.ctrl.walSecondary
        property color onAccent: skin.ctrl.walForeground
    }
