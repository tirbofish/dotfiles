...
PanelWindow {
    ...
    // -------- Colors / Fonts --------
    ThemeEngine { id: pywalTheme; isDarkMode: root.isDarkMode }
    readonly property color cBg:      Qt.rgba(pywalTheme.bgMain.r, pywalTheme.bgMain.g, pywalTheme.bgMain.b, 0.78)
    readonly property color cBgAlt:   Qt.rgba(pywalTheme.bgItem.r, pywalTheme.bgItem.g, pywalTheme.bgItem.b, 0.78)
    readonly property color cCard:    pywalTheme.bgCard
    readonly property color cFg:      pywalTheme.textPrimary
    readonly property color cMuted:   pywalTheme.textSecondary
    readonly property color cBorder:  pywalTheme.border
    readonly property color cGreen:   pywalTheme.accent
    readonly property color cRed:     pywalTheme.accentRed
    readonly property color cBlue:    pywalTheme.accentBlue
    ...
    property bool savedExpanded: false
    ...
    Rectangle {
        ...
        anchors.bottom: Configuration.barStyle === "top" ? undefined : parent.bottom
                ...
                StackLayout {
                    ...
                    ColumnLayout {
                        ...
                        Rectangle {
                            ...
                            radius: 10
                            color: savedMouse.containsMouse ? Qt.rgba(cBlue.r, cBlue.g, cBlue.b, 0.10) : "transparent"
                            ...
                            RowLayout {
                                ...
                                anchors.rightMargin: 10
                                Label {
                                    text: "Saved networks (" + savedModel.count + ")"
                                    font.family: fontText
                                    font.pixelSize: 12
                                    font.weight: 600
                                    color: cMuted
                                ...
                                BusyIndicator {
                                    ...
                                    implicitHeight: 18
                                    layer.enabled: true
                                    layer.effect: ColorOverlay { color: isDarkMode ? cGreen : cMuted }
                                }
                                Label {
                                    text: savedExpanded ? "" : ""
                                    font.family: fontIcon
                        ...
                        ListView {
                            Layout.fillWidth: true
                            Layout.preferredHeight: savedExpanded ? Math.min(210, Math.max(0, savedModel.count * 48)) : 0
                            visible: savedExpanded && savedModel.count > 0
                            clip: true
                            model: savedModel
                            spacing: 6
                    ...
                    ColumnLayout {
                        ...
                        RowLayout {
                            ...
                            MenuButton {
                                ...
                                btnColor: Qt.rgba(cBlue.r, cBlue.g, cBlue.b, 0.82)
                                textColor: pywalTheme.textOnAccent
                                icon: "󱄙"
                                kind: "primary"
                                disabled: isBusy
                                onClicked: {
