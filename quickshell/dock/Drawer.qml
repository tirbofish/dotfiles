...
PanelWindow {
    ...
    Lib.ThemeEngine { id: theme; isDarkMode: drawerWin.isDarkMode }
                        ...
                        delegate: Item {
                            ...
                            MouseArea {
                                ...
                                Rectangle {
                                    ...
                                    anchors.margins: 4
                                    radius: 12
                                    color: delegateMouse.containsMouse ? theme.subtleFillHover : "transparent"
                                }
    ...
    Rectangle {
        ...
        Column {
            ...
            Rectangle {
                ...
                height: 40
                radius: 6
                color: btnOpenMouse.containsMouse ? theme.bgItemHover : "transparent"
                Text { anchors.centerIn: parent; text: "Open App"; color: theme.textPrimary; font.pixelSize: 13 }
                MouseArea {
                    id: btnOpenMouse
                    anchors.fill: parent
                    hoverEnabled: true
            ...
            Rectangle {
                ...
                height: 40
                radius: 6
                color: btnHideMouse.containsMouse ? Qt.rgba(theme.accentRed.r, theme.accentRed.g, theme.accentRed.b, 0.18) : "transparent"
                Text { anchors.centerIn: parent; text: "Hide App"; color: theme.accentRed; font.pixelSize: 13 }
                MouseArea {
                    id: btnHideMouse
                    anchors.fill: parent
                    hoverEnabled: true
